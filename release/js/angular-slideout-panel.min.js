...
angular.module('angular-slideout-panel').service('angularSlideOutPanel', ['$q', '$rootScope', '$timeout', '$http', '$compile', '$controller', 'angularSlideOutPanelStack', 'panelResolve', function ($q, $rootScope, $timeout, $http, $compile, $controller, angularSlideOutPanelStack, panelResolve) {
  ...
  var Panel = function () {
    ...
    function Panel(options) {
      ...
      _getControllerScope(this.templateUrl, this.template, this.controller, this.resolve).then(function (scopeAndTemplate) {
  ...
  function _getControllerScope(templateUrl, template, controller, resolve) {
    var templatePromise = templateUrl ? _getTemplate(templateUrl) : $q.resolve(template);

    var templateAndResolvePromise = $q.all([templatePromise, panelResolve.resolve(resolve)]);
    ...
    return templateAndResolvePromise.then(function (templateAndVars) {
      ...
      var ctrlInstantiate = $controller(controller, locals, true);
