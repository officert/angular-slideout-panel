...
angular.module('angular-slideout-panel').service('angularSlideOutPanel', ['$q', '$rootScope', '$timeout', '$http', '$compile', '$controller', 'angularSlideOutPanelStack', 'panelResolve', function ($q, $rootScope, $timeout, $http, $compile, $controller, angularSlideOutPanelStack, panelResolve) {
  ...
  var Panel = function () {
    ...
    function Panel(options) {
      ...
      _getControllerScope(this).then(function (scopeAndTemplate) {
        ...
        openModalElements(_this._elements.modalElement, _this._elements.modalBgElement);
      });
    }
  ...
  function _getControllerScope(panelInstance) {
    var templatePromise = panelInstance.templateUrl ? _getTemplate(panelInstance.templateUrl) : $q.resolve({
      data: panelInstance.template
    });

    var templateAndResolvePromise = $q.all([templatePromise, panelResolve.resolve(panelInstance.resolve)]);
    ...
    return templateAndResolvePromise.then(function (templateAndVars) {
      ...
      var ctrlInstantiate = $controller(panelInstance.controller, locals, true);
  ...
  function getOrCreateModalBgElement(modalElement, options) {
    ...
    var bodyElement = angular.element(document.querySelector('body'));
    var existingModalBgElement = document.querySelector('.' + PANEL_ELEMENT_CLASSES.PANEL_BG_ELEMENT);
