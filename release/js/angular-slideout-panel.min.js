...
angular.module('angular-slideout-panel').service('angularSlideOutPanel', ['$q', '$rootScope', '$timeout', '$http', '$compile', '$controller', 'angularSlideOutPanelStack', 'panelResolve', function ($q, $rootScope, $timeout, $http, $compile, $controller, angularSlideOutPanelStack, panelResolve) {
  ...
  var Panel = function () {
    ...
    function Panel(options) {
      ...
      $q.all([this._getLocals(), this._getTemplate()]).then(function (localsAndTemplate) {
        ...
        openModalElements(_this._elements.modalDialogElement);
    ...
    _createClass(Panel, [{
      ...
      key: '_closePanelElement',
      value: function _closePanelElement() {
        var modalBgElement = angular.element(document.querySelector('.' + PANEL_ELEMENT_CLASSES.PANEL_BG_ELEMENT));
  ...
  function _createPanelElements(options) {
    ...
    return {
      ...
      modalDialogElement: modalDialogElement
    };
  }
...
angular.module('angular-slideout-panel').service('angularSlideOutPanelStack', ['$timeout', function ($timeout) {
  var AngularPanelStack = function () {
    ...
    _createClass(AngularPanelStack, [{
      ...
      value: function dismissAll() {
        angular.forEach(this._stack, function (panel) {
          $timeout(function () {
            panel.close();
          }, 500);
        });
